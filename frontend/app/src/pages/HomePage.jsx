...
const categories = {
  ...
  universityTasks: [
    ...
    { name: "Мат. статистика", slug: "statistics" },
    { name: "Психология", slug: "psychology" },
    { name: "Теория вероятности", slug: "probability" },
    { name: "Алгебра", slug: "university-algebra" },
    { name: "Программирование", slug: "university-programming" },
  ],
};
