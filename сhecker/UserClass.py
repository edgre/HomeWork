...
class User:
    ...
    @classmethod
    def generate(cls):
        male_names = cls.read_words_from_file("male_names.txt")
        male_surnames = cls.read_words_from_file("male_surnames.txt")
        female_names = cls.read_words_from_file("female_names.txt")
        female_surnames = cls.read_words_from_file("female_surnames.txt")
